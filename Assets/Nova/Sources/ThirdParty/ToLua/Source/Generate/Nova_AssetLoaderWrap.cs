...
public class Nova_AssetLoaderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("RenderTargetPrefix", get_RenderTargetPrefix, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_RenderTargetPrefix(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, Nova.AssetLoader.RenderTargetPrefix);
			return 1;
		}
		catch (Exception e)
		{
