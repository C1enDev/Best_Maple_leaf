...
public class Nova_CheckpointHelperWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("WarningStepsFromLastCheckpoint", get_WarningStepsFromLastCheckpoint, null);
		L.EndClass();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_WarningStepsFromLastCheckpoint(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushinteger(L, Nova.CheckpointHelper.WarningStepsFromLastCheckpoint);
			return 1;
		}
		catch (Exception e)
		{
